...
function PointObject(_construction, _name, _x, _y) {
  ...
  this.setIncrement = function(_i) {
    const old = this.getIncrement();
    Cn.canvas.undoManager.recordPropertyChange(this, 'Increment', old, _i);
  ...
  this.setShape = function(_shape) {
    const old = this.getShape();
    Cn.canvas.undoManager.recordPropertyChange(this, 'Shape', old, _shape);
    shape = _shape;
    switch (shape) {
      case 0:
