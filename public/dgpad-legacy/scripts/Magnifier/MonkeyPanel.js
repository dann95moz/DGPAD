...
function MonkeyPanel(_canvas) {
    ...
    const imgStart = $APP_PATH + "NotPacked/images/controls/anim_start.svg";
    const imgStop = $APP_PATH + "NotPacked/images/controls/anim_stop.svg";



    me.setStyles("position:absolute;overflow:hidden;z-index:8;background-size:" + _w + "px " + _h + "px;background-position:center;background-repeat:no-repeat;cursor:pointer");
