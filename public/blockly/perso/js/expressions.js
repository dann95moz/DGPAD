...
//     value_obj = value_obj.replace(/\(|\)/g, '"'); // Reemplazar paréntesis con comillas
...
Blockly.JavaScript["dgpad_inputs_value"] = function (block) {
  ...
  return [`DG.inputValue(${Blockly.JavaScript.quote_(id)})`, Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
