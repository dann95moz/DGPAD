...
- [x] Definir type BoardPointsRequest, BoardPointsResult
- [x] Definir type ConversionResult (para calculadora)
- [x] Definir type HistorySnapshot, HistoryAction
- [x] Definir type PropertyConstraint, PropertySchema
- [x] Definir type MacroPromptResponse, MacroExecutionState
- [x] Definir type ExportFormat, ExportOptions, ExportResult
- [x] Definir type BridgeError, BridgeErrorCode
- [x] Exportar todos los tipos en index
